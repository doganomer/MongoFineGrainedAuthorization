...
@XmlType(name = "ObligationExpressionsType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "obligationExpression"
})
public class ObligationExpressionsType {

    @XmlElement(name = "ObligationExpression", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", required = true)
