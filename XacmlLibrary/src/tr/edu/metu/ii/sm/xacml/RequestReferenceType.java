...
@XmlType(name = "RequestReferenceType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "attributesReference"
})
public class RequestReferenceType {

    @XmlElement(name = "AttributesReference", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", required = true)
