...
@XmlType(name = "MultiRequestsType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "requestReference"
})
public class MultiRequestsType {

    @XmlElement(name = "RequestReference", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", required = true)
