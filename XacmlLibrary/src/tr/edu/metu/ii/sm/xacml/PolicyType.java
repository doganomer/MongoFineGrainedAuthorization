...
@XmlType(name = "PolicyType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "description",
    "policyIssuer",
    "policyDefaults",
    "target",
...
public class PolicyType {
    ...
    @XmlElement(name = "Description", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
    protected String description;
    @XmlElement(name = "PolicyIssuer", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
    protected PolicyIssuerType policyIssuer;
    @XmlElement(name = "PolicyDefaults", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
    ...
    @XmlElements({
        @XmlElement(name = "CombinerParameters", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", type = CombinerParametersType.class),
        @XmlElement(name = "RuleCombinerParameters", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", type = RuleCombinerParametersType.class),
        @XmlElement(name = "VariableDefinition", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", type = VariableDefinitionType.class),
        @XmlElement(name = "Rule", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", type = RuleType.class)
    })
    protected List<Object> combinerParametersOrRuleCombinerParametersOrVariableDefinition;
    @XmlElement(name = "ObligationExpressions", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
