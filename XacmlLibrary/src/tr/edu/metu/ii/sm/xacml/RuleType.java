...
@XmlType(name = "RuleType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "description",
    "target",
    "condition",
...
public class RuleType {
    ...
    @XmlElement(name = "Condition", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
