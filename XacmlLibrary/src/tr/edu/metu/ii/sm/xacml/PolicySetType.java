...
@XmlType(name = "PolicySetType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "description",
    "policyIssuer",
    "policySetDefaults",
    "target",
...
public class PolicySetType {
    ...
    @XmlElement(name = "PolicySetDefaults", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
