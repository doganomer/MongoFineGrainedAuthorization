...
@XmlType(name = "MissingAttributeDetailType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "attributeValue"
})
public class MissingAttributeDetailType {

    @XmlElement(name = "AttributeValue", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
