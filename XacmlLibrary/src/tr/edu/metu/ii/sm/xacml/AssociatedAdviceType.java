...
@XmlType(name = "AssociatedAdviceType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "advice"
})
public class AssociatedAdviceType {

    @XmlElement(name = "Advice", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", required = true)
