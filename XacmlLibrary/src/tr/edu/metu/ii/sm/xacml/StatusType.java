...
@XmlType(name = "StatusType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "statusCode",
    "statusMessage",
    "statusDetail"
})
public class StatusType {
    ...
    @XmlElement(name = "StatusCode", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", required = true)
    protected StatusCodeType statusCode;
    @XmlElement(name = "StatusMessage", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
    protected String statusMessage;
    @XmlElement(name = "StatusDetail", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
