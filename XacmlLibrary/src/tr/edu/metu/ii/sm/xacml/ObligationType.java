...
@XmlType(name = "ObligationType", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", propOrder = {
    "attributeAssignment"
})
public class ObligationType {

    @XmlElement(name = "AttributeAssignment", namespace = "urn:oasis:names:tc:xacml:3.0:core:schema:wd-17")
